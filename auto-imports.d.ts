...
declare global {
  ...
  const MergeFields: typeof import('./src/constants/mergeFields')['MergeFields']
  ...
  const deleteVersion: typeof import('./src/services/module-service')['deleteVersion']
  const deleteVresion: typeof import('./src/services/module-service')['deleteVresion']
  const detectDuplicateKey: typeof import('./src/utils/uniqueKeys')['detectDuplicateKey']
  const doEntityCommand: typeof import('./src/services/module-service')['doEntityCommand']
  const doMerge: typeof import('./src/services/module-service')['doMerge']
  ...
  const ensureUniqueKeys: typeof import('./src/utils/uniqueKeys')['ensureUniqueKeys']
  ...
  const merge_columns: typeof import('./src/constants/index')['merge_columns']
  ...
  const useGetMergeComponent: typeof import('./src/hooks/useGetMergeComponent')['useGetMergeComponent']
