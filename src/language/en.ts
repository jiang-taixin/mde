export default {
  ...
  activeTips:"There are some danger,are you sure you want to go?",
  deleteVersionTips:"This operation will delete all the related data in this version and can't be restored. Are you sure to proceed?",
